...
public class Lab3
{
     ...
     {
       System.out.println("Lab 3 for <Harley Combest>");
	Scanner keyboard = new Scanner(System.in);
         ...
         // and double variables dA, dB here.
         // Intialize all variable with zero.
	 ...
	 // Prompt the user to provide a secound double value
	 // Similar to statements above
	 System.out.println("Enter the total sales tax from your most recent purchase.");
